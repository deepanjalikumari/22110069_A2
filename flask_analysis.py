...
# Load Bandit summary data for Flask
csv_file = "bandit_summary2.csv"  # Updated file name for Flask analysis
...
# RQ1: Timeline analysis for High Severity Vulnerabilities (Flask)
...
plt.title("Flask: Timeline of High Severity Vulnerability Introduction and Fixes")
plt.tight_layout()
plt.savefig("flask_rq1_high_severity_timeline.png")  # Updated file name
plt.close()

# RQ2: Patterns of vulnerability introduction and elimination (Flask)
plt.figure(figsize=(12, 6))
...
plt.title("Flask: Patterns of Different Severity Levels over Commits")
plt.legend(title='Severity Level')
plt.tight_layout()
plt.savefig("flask_rq2_severity_patterns.png")  # Updated file name
plt.close()

# RQ3: Most Frequent CWEs across Flask repository
...
plt.title("Flask: Top 10 Most Frequent CWEs")
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig("flask_rq3_cwe_frequencies.png")  # Updated file name
plt.close()

print("Flask research analysis completed. Check the generated plots!")
